...
root.title("NFT Mint Automation")
...
open_browser = Button(text="Click here to Open chrome Browser", command=open_chrome_profile, bg="#bd2626",
                      font=(my_font, 10))
open_browser.pack(anchor=N, pady=5, padx=5)

# File folder input
folder = Button(root, text="Add Upload Folder", font=(my_font, 10), bg="orange", command=upload_folder_input)
folder.pack(anchor=N, pady=1, padx=1)

start_button = Button(text="Upload the preset and click Start Main Loop", command=main_program_loop, bg="green",
                      font=(my_font, 10))
